...
const Home = () => {
  ...
  return (
    <div className="max-w-3xl xl:max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-main">
      <Topics />
      <div className="ml-4">
        {token ? (
          user && (
            <>
              ...
              <div className="bg-white mt-4 px-2 py-2 rounded-b-md">
                <Link href="/topic/create" >
                  <a className="inline-block bg-green-500 hover:bg-green-400 focus:outline-none text-white font-bold py-2 px-8 rounded">
                    发布话题
                  </a>
                </Link>
              </div>
          ...
          <div className="bg-white px-2 py-4">
            ...
            <Link href="/signin">
              <a className="shadow inline-block bg-green-500 hover:bg-green-400 focus:ring focus:outline-none text-white font-bold py-2 px-8 rounded">
                登录
              </a>
            </Link>
          </div>
