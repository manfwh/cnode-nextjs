...
export default function Home() {
  ...
  const { data } = useSWR(loginname ? `https://cnodejs.org/api/v1/user/${loginname}` : null, fetcher)
        ...
        <div className="ml-4">
          {
            token
              ? user && (
                <>
                  <div className="bg-gray-200 text-sm px-2 py-2 rounded-t-md text-gray-600">个人信息</div>
              ...
              : (
                <div className="bg-white px-2 py-4">
                  ...
                  <Link href="/signin">
                    <a className="shadow inline-block bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-8 rounded">登录</a>
                  </Link>
                </div>
              )
          }
